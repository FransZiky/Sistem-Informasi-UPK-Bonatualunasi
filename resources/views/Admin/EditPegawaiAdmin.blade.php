...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="card">
            <div class="card-body">
                <center><h4 class="mt-2"><b>EDIT DATA PEGAWAI</b></h4></center> <br> 
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                <button type="submit" onclick="return confirm('Apakah anda yakin mengubah data berikut?');" class="btn btn-success btn-md" style="float: left; margin-left:30px">UBAH</button> 
