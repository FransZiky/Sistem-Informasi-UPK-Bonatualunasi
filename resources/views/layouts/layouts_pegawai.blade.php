...
<nav class="navbar navbar-expand-lg navbar-dark text-white" style="background-color: #4C7EAD"> 
    <div class="container">
        ...
        <a class="nav-link" href="{{ url('/dashboard_admin') }}">BERANDA</a>
            <a class="nav-link" style="bottom-right:10px" href="{{ url('/Pegawai') }}">PEGAWAI</a>
...
<nav class="navbar navbar-expand-lg navbar-dark text-white" style="background-color: #4C7EAD"> 
    <div class="container">
        <div class="navbar-nav">
            ...
            <a class="nav-link" style="bottom-right:10px" href="{{ url('/Nasabah') }}">NASABAH</a>
            <div class="dropdown">
                <button class="dropbtn" style="bottom-right:10px" href="{{ url('/Bukti_Pembayaran') }}">BUKTI PEMBAYARAN</button>
                <div class="dropdown-content">
                    <a href="/bukti_kredit">Bukti Kredit</a>
                    <a href="/bukti_kwitansi">Bukti Kwitansi</a>
                </div>
            </div>
            <a class="nav-link" style="bottom-right:10px" href="{{ url('/laporan_akhir') }}">LAPORAN AKHIR</a>
