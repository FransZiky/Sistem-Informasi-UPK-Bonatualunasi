...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="card">
            <div class="card-body">
                <form method="post" enctype="multipart/form-data"  action="{{url('/tambahPegawaiPost')}}">
                {{ csrf_field() }}
                    <center>
                        <h4 class="mt-2"><b>TAMBAH DATA PEGAWAI</b></h4>
                    </center>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-success btn-md" style="float: left; margin-left:10px">LANJUT</button>
